...
Route::middleware(['auth:sanctum'])->put('/utilisateurs/{idutilisateur}', [UtilisateurController::class,'majUtilisateur']);
...
Route::middleware(['auth:sanctum'])->get("/inventaire/{idutilisateur}", [ContientController::class, 'afficherItemsInventaire']);
Route::middleware(['auth:sanctum'])->put('/inventaire/{idutilisateur}',[UtilisateurController::class, 'equiperItem']);
...
Route::middleware(['auth:sanctum'])->post('/magasin/{idutilisateur}', [ContientController::class,'achatItem']);
